...
CREATE TABLE `commerce` (
  ...
  `Accountancy` int DEFAULT NULL,
  `Business_Studies` int DEFAULT NULL,
...
INSERT INTO `commerce` VALUES (105,89,89,89,89,89,99,97);
...
-- Dump completed on 2024-01-06 14:58:54
